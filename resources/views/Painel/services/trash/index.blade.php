                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'services.search.trash', 'class' => 'form form-search form-ds']) !!}
                                ...
                                @forelse($data as $service)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('services.edit.trash', $service->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-restore="{{$service->id}}" href="javascript:;" class="restore btn btn-outline-info btn-info"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                            ...
                                            <a id-remove="{{$service->id}}" href="javascript:;" class="remove_force btn btn-outline-danger btn-dark"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
