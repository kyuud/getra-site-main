                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('services.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus-square"></i> Novo Serviços</a>

                            @can("service-clearTable")
                            @if($totalItens != 0)
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'services.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'services.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center pt-2">
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input"
                                                       id="{{$service->title}}" name="ids[]" value="{{$service->id}}">
                                                <label for="{{$service->title}}" class="custom-control-label">&nbsp;</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <img alt="{{$service->title}}"
                                                 ...
                                                 src='{{ url("uploads/services/$service->image") }}' />
                                        ...
                                        <td>
                                            ...
                                            @can("service-destroyFake")
                                            <a id-remove="{{$service->id}}" href="javascript:;" class="remove btn btn-outline-danger btn-danger"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                ...
                                @empty
                                    <tr>
                                        <p>Nenhum Serviços Cadastrado</p>
                                    </tr>
                                @endforelse
