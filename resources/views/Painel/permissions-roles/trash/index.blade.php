        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Permissões a Papeis Excluídos</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'permissions-roles.search.trash', 'class' => 'form form-search form-ds']) !!}
                            ...
                            <tbody>
                                ...
                                @forelse($data as $permissionRole)
                                    <tr>
                                        ...
                                        <td>
                                            {{$permissionRole->permission_label}}
                                            <i style="color: #909aa0" class="fas fa-question-circle"
                                               data-toggle="tooltip" data-placement="top" title=""
                                               data-original-title="{{$permissionRole->permission_name}}">

                                            </i>
                                        </td>

                                        <td>
                                            {{$permissionRole->role_label}}
                                            <i style="color: #909aa0" class="fas fa-question-circle"
                                               data-toggle="tooltip" data-placement="top" title=""
                                               data-original-title="{{$permissionRole->role_name}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('permissions-roles.edit.trash', $permissionRole->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-restore="{{$permissionRole->id}}" href="javascript:;" class="restore btn btn-outline-info btn-info"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                            ...
                                            <a id-remove="{{$permissionRole->id}}" href="javascript:;" class="remove_force btn btn-outline-danger btn-dark"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
