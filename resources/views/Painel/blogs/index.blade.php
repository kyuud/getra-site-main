                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('blogs.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus-square"></i> Novo Post</a>
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'blogs.search', 'class' => 'form form-search form-ds']) !!}
                                    ...
                                    @forelse($data as $blog)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a id-remove="{{$blog->id}}" href="javascript:;" class="remove btn btn-outline-danger btn-danger"
                                                data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
