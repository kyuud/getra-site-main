        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Membros da equipe Cadastrados</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'teams.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'teams.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $team)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('teams.edit.trash', $team->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-restore="{{$team->id}}" href="javascript:;" class="restore btn btn-outline-info btn-info"
                                            data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                            ...
                                            <a id-remove="{{$team->id}}" href="javascript:;" class="remove_force btn btn-outline-danger btn-dark"
                                            data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                ...
                                @empty
                                    <tr>
                                        <p>Lixeira de membros da equipe Vazia</p>
                                    </tr>
                                @endforelse
