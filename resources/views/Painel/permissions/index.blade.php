                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('permissions.create')}}" class="btn btn-icon icon-left btn-success">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'permissions.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'permissions.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table width="100%" class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $permission)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a id-remove="{{$permission->id}}" href="javascript:;" class="remove btn btn-outline-danger btn-danger"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                ...
                                @empty
                                    <tr>
                                        <p>Nenhuma Permissã Cadastrada</p>
                                    </tr>
                                @endforelse
