                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('funfacts.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus-square"></i> Novo Fato</a>

                            @can("funfact-clearTable")
                            @if($totalItens != 0)
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'funfacts.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'funfacts.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $funfact)
                                    <tr>
                                        <td class="text-center pt-2">
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input"
                                                       id="{{$funfact->title}}" name="ids[]" value="{{$funfact->id}}">
                                                <label for="{{$funfact->title}}" class="custom-control-label">&nbsp;</label>
                                            </div>
                                        </td>

                                        {{-- <td>
                                            <img alt="{{$funfact->title}}"
                                                 ...
                                                 src='{{ url("uploads/funfacts/$funfact->image") }}' />
                                        ...
                                        <td>{{ date('d-m-Y H:i:s', strtotime($funfact['created_at'])) }}</td>
                                        <td>
                                            {{-- BOTÃO PARA EDITAR O REGISTRO --}}
                                            <a href="{{route('funfacts.edit', $funfact->id)}}" class="btn btn-primary"
                                            ...
                                            @can("funfact-destroyFake")
                                            <a id-remove="{{$funfact->id}}" href="javascript:;" class="remove btn btn-outline-danger btn-danger"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
