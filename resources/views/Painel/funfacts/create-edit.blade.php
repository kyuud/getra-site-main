        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if( isset($data) )
                        {!! Form::model($data, ['route' => ['funfacts.update', $data->id], 'class' => 'form', 'files' => true, 'method' => 'PUT']) !!}
                    @else
                        {!! Form::open(['route' => 'funfacts.store', 'id'=>'formStore', 'class' => 'form', 'files' => true]) !!}
                    @endif
                        ...
                        <div class="form-group">
                            <label>Título</label>
                            {!! Form::text('title', null, ['placeholder' => 'Digite o título do funfact aqui...', 'class' => "form-control"]) !!}
                            @error('title')<div class="text-danger">{{ "***$message" }}</div>@enderror
                        </div>

                        {{-- <div class="form-group">
                            <label>Url</label>
                            {!! Form::text('url', null, ['placeholder' => 'Digite a url do funfact aqui...', 'class' => 'form-control']) !!}
                            @error('url')<div class="text-danger">{{ "***$message" }}</div>@enderror
                        </div> --}}

                        <div class="form-group">
                            <label>Valor</label>
                            {!! Form::textarea('value', null, ['placeholder' => 'Digite o Valor do funfact aqui...', 'class' => 'form-control']) !!}
                        ...
                        {{-- @if( isset($data) )
                            <div class="form-group">
                                ...
                                <img class="form-control image-atual" style="width: 100%; height: 100%"
                                    src='{{ url("uploads/funfacts/$data->image") }}' />
                            </div>
                        @endif --}}
