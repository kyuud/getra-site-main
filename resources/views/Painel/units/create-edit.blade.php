        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Gestão de Unidades - <b>{{$data->title ?? 'Novo'}}</b></h4>
                </div>
                <div class="card-body">

                    @if( isset($data) )
                        {!! Form::model($data, ['route' => ['units.update', $data->id], 'class' => 'form', 'files' => true, 'method' => 'PUT']) !!}
                    @else
                        {!! Form::open(['route' => 'units.store', 'id'=>'formStore', 'class' => 'form', 'files' => true]) !!}
                    @endif
                    ...
                    <div class="form-group">
                        <label>Título</label>
                        {!! Form::text('title', null, ['placeholder' => 'Digite o título do card aqui...', 'class' => "form-control"]) !!}
                        @error('title')<div class="text-danger">{{ "***$message" }}</div>@enderror
                    </div>

                    <div class="form-group">
                        <label>Descrição</label>
                        {!! Form::textarea('description', null, ['placeholder' => 'Digite a texto do blog aqui...', 'class' => 'form-control summernote']) !!}
