                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'companies.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'companies.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $companies)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('companies.edit.trash', $companies->id)}}" class="btn btn-primary"
                                ...
                                @empty
                                    <tr>
                                        <p>Lixeira de endereços Vazia</p>
                                    </tr>
                                @endforelse
