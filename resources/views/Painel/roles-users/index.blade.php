        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Papeis a Usuários Cadastrados</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('roles-users.create')}}" class="btn btn-icon icon-left btn-success">
                                <i class="fas fa-plus-square"></i>
                                Novo Papel ao Usuário
                            </a>
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'roles-users.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'roles-users.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table width="100%" class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $roleUser)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('roles-users.edit', $roleUser->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-remove="{{$roleUser->id}}" href="javascript:;" class="remove btn btn-outline-danger btn-danger"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                ...
                                @empty
                                    <tr>
                                        <p>Nenhum Papel a Usuário Cadastrado</p>
                                    </tr>
                                @endforelse
