                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'roles.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'roles.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                                ...
                                @forelse($data as $role)
                                    <tr>
                                        <td class="text-center pt-2">
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input"
                                                       id="{{$role->name}}" name="ids[]" value="{{$role->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('roles.edit.trash', $role->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-restore="{{$role->id}}" href="javascript:;" class="restore btn btn-outline-info btn-info"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                            ...
                                            <a id-remove="{{$role->id}}" href="javascript:;" class="remove_force btn btn-outline-danger btn-dark"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
