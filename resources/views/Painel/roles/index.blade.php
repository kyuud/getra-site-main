                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('roles.create')}}" class="btn btn-icon icon-left btn-success">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'roles.search', 'class' => 'form form-search form-ds']) !!}
                                ...
                                @forelse($data as $role)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a id-remove="{{$role->id}}" href="javascript:;" class="remove btn btn-outline-danger btn-danger"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
