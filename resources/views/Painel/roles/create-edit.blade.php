        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Gestão de Papeis - <b>{{$data->label ?? 'Novo'}}</b></h4>
                </div>
                <div class="card-body">

                    @if( isset($data) )
                        {!! Form::model($data, ['route' => ['roles.update', $data->id], 'class' => 'form', 'files' => true, 'method' => 'PUT']) !!}
                    @else
                        {!! Form::open(['route' => 'roles.store', 'id'=>'formStore', 'class' => 'form', 'files' => true]) !!}
                    @endif
