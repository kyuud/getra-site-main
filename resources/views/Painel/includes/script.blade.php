    ...
    table.on('click', '.remove', function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type   : 'post',
                    url    : "{{route("$route.destroyWithAjaxFake")}}",
                    data   : {
                        "_token": "{{ csrf_token()}}",
                        id      : id_registro
                    },
    ...
    table.on('click', '.remove_force', function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type   : 'post',
                    url    : "{{route("$route.destroyWithAjax")}}",
                    data   : {
                        "_token": "{{ csrf_token()}}",
                        id      : id_registro
                    },
        ...
        if (checked) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type   : 'post',
                        url    : "{{route("$route.destroyMultWithAjaxFake")}}",
                        data   : data,
                        success: function (data) {
        ...
        if (checked) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type   : 'post',
                        url    : "{{route("$route.destroyMultWithAjax")}}",
                        data   : data,
                        success: function (data) {
    ...
    buttomClearTableForce.click(function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type   : 'post',
                    url    : "{{route("$route.clearTableForce")}}",
                    data   :  {"_token": "{{ csrf_token()}}"},
                    success: function (data) {
