                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'portfolios.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'portfolios.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $portfolio)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('portfolios.edit.trash', $portfolio->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-restore="{{$portfolio->id}}" href="javascript:;" class="restore btn btn-outline-info btn-info"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                            ...
                                            <a id-remove="{{$portfolio->id}}" href="javascript:;" class="remove_force btn btn-outline-danger btn-dark"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                ...
                                @empty
                                    <tr>
                                        <p>Lixeira de Portfolios Vazia</p>
                                    </tr>
                                @endforelse
