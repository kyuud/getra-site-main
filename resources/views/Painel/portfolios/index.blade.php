                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('portfolios.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus-square"></i> Novo Portfolio</a>

                            @can("portfolio-clearTable")
                            @if($totalItens != 0)
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'portfolios.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'portfolios.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $portfolio)
                                    <tr>
                                        <td class="text-center pt-2">
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input"
                                                    id="{{$portfolio->title}}" name="ids[]" value="{{$portfolio->id}}">
                                                <label for="{{$portfolio->title}}" class="custom-control-label">&nbsp;</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <img alt="{{$portfolio->title}}"
                                                ...
                                                src='{{ url("uploads/portfolios/$portfolio->image") }}' />
                                        ...
                                        <td>
                                            ...
                                            @can("portfolio-destroyFake")
                                            <a id-remove="{{$portfolio->id}}" href="javascript:;" class="remove btn btn-outline-danger btn-danger"
                                            data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                ...
                                @empty
                                    <tr>
                                        <p>Nenhum Portfolio Cadastrado</p>
                                    </tr>
                                @endforelse
