            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <img style="display: block; margin-left: auto;margin-right: auto;width: 100%;" src="{{url('Site/images/logonova-getra.png')}}" alt="logo">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('login') }}" method="POST" class="needs-validation">
                                    ...
                                    <form action="{{ route('login') }}" method="POST" class="needs-validation">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" placeholder="Digite o seu e-mail aqui..."
                                                class="form-control" tabindex="1" required autofocus>
                                ...
                                <!-- <div class="text-center mt-4 mb-3">
                                    <div class="text-job text-muted">Login com redes sociais</div>
                                </div>
