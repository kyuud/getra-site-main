                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'patrimony.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'patrimony.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    <img alt="{{$item->title}}"
                                         ...
                                         src='{{ asset('storage/patrimonies/'.$item->image_url) }}'/>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('patrimony.edit.trash', $item->id)}}" class="btn btn-primary"
