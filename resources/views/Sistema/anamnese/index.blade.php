                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('anamnese.create')}}" class="btn btn-icon icon-left btn-success">
                                <i class="fas fa-plus-square"></i> Novo Exame
                            </a>

                            {{-- BOTÃO PARA GERAR RELATÓRIO --}}
                            <a href="{{route('anamnese.pdf')}}" target="_blank" class="btn btn-icon icon-left btn-outline-danger">
                                <i class="fas fa-file-pdf"></i> Gerar PDF
                            </a>

                            @can("anamnese-clearTable")
                                @if($totalItens != 0)
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'anamnese.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'anamnese.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                            ...
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{'../uploads/anamneses/pdfs/' . $item->pdf}}" class="btn btn-primary"
                                        ...
                                        <a href="{{'../uploads/anamneses/digpdfs/' . $item->digpdf}}" class="btn btn-dark"
                                            data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
