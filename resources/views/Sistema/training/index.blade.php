                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('training.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus-square"></i> Novo Treinamento</a>

                            {{-- BOTÃO PARA GERAR RELATÓRIO --}}
                            <a href="{{route('training.pdf')}}" target="_blank" class="btn btn-icon icon-left btn-outline-danger">
                                <i class="fas fa-file-pdf"></i> Gerar PDF</a>

                            @can("training-clearTable")
                            @if($totalItens != 0)
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'training.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'training.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                    ...
                    <table width="100%" class="table table-striped table-hover" id="tableExport">
                        <thead>
                            <tr>
                                ...
                                <th style="width:auto;">Treinamento</th>
                                <th style="width:auto;">Início Contrato</th>
                                <th style="width:auto;">Prazo</th>
                            ...
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('training.edit', $item->id)}}" class="btn btn-primary"
                                        ...
                                        <a href="{{route('training.pdf.company', $item->company_id)}}" class="btn btn-primary"
                                        data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
