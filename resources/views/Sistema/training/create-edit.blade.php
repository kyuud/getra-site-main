...
@push('js-extra')
    ...
    @include('Sistema.training.companies')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if( isset($data) )
                        {!! Form::model($data, ['route' => ['training.update', $data->id], 'class' => 'form', 'files' => true, 'method' => 'PUT']) !!}
                    @else
                        {!! Form::open(['route' => 'training.store', 'id'=>'formStore', 'class' => 'form', 'files' => true]) !!}
                    @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('treinamento', ['treinamento1' => 'treinamento1',
                                                                'treinamento2'=>'treinamento2',
                                                                'treinamento3'=>'treinamento3'],
                                                    null, ['class'=>'form-control','placeholder'=>'Selecione o treinamento']) !!}

                                    @error('treinamento')<div class="text-danger">{{ "***$message" }}</div>@enderror
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Tipo</label>
                                    {!! Form::select('tipo', ['tipo1' => 'tipo1',
                                                                'tipo2'=>'tipo2',
                                                                'tipo3'=>'tipo3'],
                                                    null, ['class'=>'form-control','placeholder'=>'Selecione o tipo']) !!}
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label> Quantidade de funcionários</label>
                                        ...
                                        ['placeholder' => '...', 'class' => "form-control", "name" => "qtd"]) !!}
