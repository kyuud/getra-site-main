                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'financial.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'financial.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                                ...
                                @forelse($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('financial.edit.trash', $item->id)}}" class="btn btn-primary"
