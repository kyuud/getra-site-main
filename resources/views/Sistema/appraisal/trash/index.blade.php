                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'employees.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'employees.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tbody>
                                ...
                                @forelse($data as $employees)
                                    <tr>
                                        <td class="text-center pt-2">
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input"
                                                    id="{{$employees->id}}" name="ids[]" value="{{$employees->id}}">
                                                <label for="{{$employees->id}}" class="custom-control-label">&nbsp;</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>{{ formatDate($employees['created_at']) }}</td>
                                        <td>
                                            {{-- BOTÃO PARA EDITAR O REGISTRO --}}
                                            <a href="{{route('employees.edit.trash', $employees->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-restore="{{$employees->id}}" href="javascript:;" class="restore btn btn-outline-info btn-info"
                                            data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                            ...
                                            <a id-remove="{{$employees->id}}" href="javascript:;" class="remove_force btn btn-outline-danger btn-dark"
                                            data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
