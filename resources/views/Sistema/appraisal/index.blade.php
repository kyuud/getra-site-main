                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('appraisal.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus-square"></i> Novo Laudo</a>

                            {{-- BOTÃO PARA GERAR RELATÓRIO --}}
                            <a href="{{route('appraisal.pdf')}}" target="_blank" class="btn btn-icon icon-left btn-outline-danger">
                                <i class="fas fa-file-pdf"></i> Gerar PDF</a>

                            @can("appraisal-clearTable")
                            @if($totalItens != 0)
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'appraisal.search', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'appraisal.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                    ...
                    <table width="100%" class="table table-striped table-hover" id="tableExport">
                        <thead>
                            <tr>
                                ...
                                <th style="width:auto;">Início Contrato</th>
                                <th style="width:auto;">Vigência</th>
                        ...
                        <tbody>
                            ...
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td>{{ formatDate($item['validity'], 'd/m/Y') }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('appraisal.edit', $item->id)}}" class="btn btn-primary"
                                        ...
                                        <a href="{{route('appraisal.pdf.company', $item->company_id)}}" class="btn btn-primary"
                                        data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                        target="_blank" data-original-title="Baixar este item!"> PDF
                                            <i class="fas fa-download"></i>
                                        </a>

                                        {{-- BOTÃO PARA EXCLUIR O REGISTRO --}}
                                        @can("appraisal-destroyFake")
