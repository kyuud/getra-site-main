...
@section('content')
    ...
    <h5>Relatório de Laudo por Empresa</h5>
                    ...
                    <div class="card-body">
                        ...
                        @forelse($data as $item)
                            ...
                            <div class="row" style="">
                                <div class="col-md-12" style="">
                                    <div class="form-group">
                                        ...
                                        <div style="background: #efeeee; border-radius: 5px; padding: 5px; margin-top: -5px; color: #343232">{{$item->titulo}}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="">
                                ...
                                <div class="col-md-6" style="width: 45%; float: right">
                                    <div class="form-group">
                                        <label><b>Vigência</b></label>
                                        <div style="background: #efeeee; border-radius: 5px; padding: 5px; margin-top: -5px; color: #343232">{{ formatDate($item->validity, 'd/m/Y')}}</div>
                                    </div>
                                </div>
                            </div>
