            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Registro dos meses de atendimento</h4>
                    </div>
                        ...
                        @forelse($data as $item)
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-12">
                                <div class="card l-bg-green-light">
                                    <a style="text-decoration: none;" href="{{ route('month-attendance', [$year, $item->month]) }}">
                                        <div class="card-statistic-3">
                                            <div class="card-icon card-icon-large"><i class="fa fa-clock"></i></div>
                                            <div class="card-content">
                                                <h4 class="card-title">{{$item->month}}/{{$item->year}}</h4>
