                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('periodical.create')}}" class="btn btn-icon icon-left btn-success">
                                <i class="fas fa-plus-square"></i> Novo Exame
                            </a>

                            {{-- BOTÃO PARA GERAR RELATÓRIO --}}
                            <a href="{{route('periodical.pdf')}}" target="_blank" class="btn btn-icon icon-left btn-outline-danger">
                                <i class="fas fa-file-pdf"></i> Gerar PDF
                            </a>

                            @can("periodical-clearTable")
                                @if($totalItens != 0)
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'periodical.search', 'class' => 'form form-search form-ds']) !!}
                            ...
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{'../uploads/periodicals/pdfs/' . $item->pdf}}" class="btn btn-primary"
