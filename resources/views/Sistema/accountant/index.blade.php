                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <a href="{{route('accountant.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus-square"></i>
                                Novo
                            </a>

                            {{-- BOTÃO PARA GERAR RELATÓRIO --}}
                            <a href="{{route('accountant.pdf')}}" target="_blank" class="btn btn-icon icon-left btn-outline-danger">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <form action="{{route('accountant.search')}}" method="GET" class="form form-search form-ds">
                    ...
                    <form action="{{route('accountant.destroyMultWithAjax')}}" method="POST" id="formDestroyMult">
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            @forelse($data as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->id}}</td>
                                    <td>{{$item->name}}</td>
                                    <td>{{formatCnpjCpf($item->cpnj_cpf)}}</td>
                                    <td>{{$item->amount}}</td>
                                    <td>{{$item->observation}}</td>
                                    <td>
                                        {{-- BOTÃO PARA EDITAR O REGISTRO --}}
                                        <a href="{{route('accountant.edit', $item->id)}}" class="btn btn-primary" data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px" data-original-title="Visualizar mais detalhes deste item!">
                            ...
                            @empty
                                ...
                                <tr>
                                    <p>Nenhum contador cadastrado</p>
                                </tr>
