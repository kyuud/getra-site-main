...
@section('content')
    ...
    <h1 style="color: #028738; text-align: center; font-size: 24px;">Relatório Geral - Contadores</h1>
                ...
                <div class="card-body" style="padding: 20px 25px; color: #555;">
                    ...
                    <table class="table table-striped table-hover" id="tableExport">
                        ...
                        <tr>
                            ...
                            <th style="width: 20%;">Nome do Contador</th>
                            <th style="width: 15%;">CNPJ/CPF</th>
                            <th style="width: 15%;">Valor da comissão</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        @forelse($data as $key=>$item)
                            <tr>
                                ...
                                <td style="text-align: center;">{{ $item->accountants->name }}</td>
                                <td style="text-align: center;">{{ formatCnpjCpf($item->accountants->cnpj_cpf) }}</td>
                                <td style="text-align: center;">{{ formatMoney($item->accountants->comission) }}</td>
