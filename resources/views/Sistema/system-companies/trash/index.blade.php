                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            {!! Form::open(['route' => 'system-companies.search.trash', 'class' => 'form form-search form-ds']) !!}
                    ...
                    {!! Form::open(['route' => 'system-companies.destroyMultWithAjax', 'id'=>'formDestroyMult']) !!}
                                ...
                                @forelse($data as $companies)
                                    <tr>
                                        <td class="text-center pt-2">
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input"
                                                       id="{{$companies->street}}" name="ids[]" value="{{$companies->id}}">
                                                <label for="{{$companies->street}}" class="custom-control-label">&nbsp;</label>
                                            </div>
                                        </td>

                                        <td>{{$companies->name}}</td>
                                        <td>{{$companies->cnpj}}</td>
                                        <td>{{$companies->fantasyname}}</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('system-companies.edit.trash', $companies->id)}}" class="btn btn-primary"
                                            ...
                                            <a id-restore="{{$companies->id}}" href="javascript:;" class="restore btn btn-outline-info btn-info"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
                                            ...
                                            <a id-remove="{{$companies->id}}" href="javascript:;" class="remove_force btn btn-outline-danger btn-dark"
                                               data-toggle="tooltip" style="min-width:43px; margin-bottom: 5px"
