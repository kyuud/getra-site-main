<?php
    ...
    use App\Http\Requests\Sistema\AnamneseFormRequest;
    ...
    class AnamneseController extends StandardController
    {
        protected $model, $employee, $company;
        protected $title       = "Anamnese";
        protected $view        = "Sistema.anamnese";
        protected $route       = "anamnese";
        protected $permissions = "anamnese";
        protected $name        = ["single" => "Anamnese", "plus" => "Anamnese"];


        public function __construct(Anamnese $anamnese, Employee $employee, Company $company, Doctor $doctor)
        {
        ...
        public function create()
        {
            ...
            return view("{$this->view}.create-edit", compact('title', 'active', 'route', 'name', 'companies', 'employees', 'doctors'));
        }
         ...
         */
        public function store(anamneseFormRequest $request)
        {
            ...
            $save = $this->savePdf("uploads/anamneses/pdfs/$name", $pdf);

            $url  = "../uploads/anamneses/pdfs/$name";

            # CRIA UM NOME ÚNICO
            $name_dig = uniqid(date('YmdHis')) . ".pdf";

            # CHAMA A FUNCTION PARA SALVAR O PDF EM UPLOADS
            $save = $this->saveDigPdf("uploads/anamneses/digpdfs/$name_dig", $digpdf);

            $url = "../uploads/anamneses/digpdfs/$name_dig";
         ...
         * @return \Illuminate\Http\Response
         */
        public function storeAdd(AnamneseFormRequest $request)
        {
         ...
         * @return \Illuminate\Http\Response
         */
        public function update(AnamneseFormRequest $request, $id)
        {
            //Pega todos os dados do categoria
            $dataForm = $request->all();
         ...
         * @return \Illuminate\Http\Response
         */
        public function updateTrash(AnamneseFormRequest $request, $id)
        {
            //Pega todos os dados do categoria
            $dataForm = $request->all();
        ...
        public function search(Request $request)
        {
            ...
            $data = $this->model
            ->select("anamneses.*")
            ->where("anamneses.deleted_at", '=', null)
            ->leftJoin('employees', 'employees.id', '=', 'anamneses.employee_id')
