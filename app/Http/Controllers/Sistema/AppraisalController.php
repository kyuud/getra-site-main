<?php
    ...
    use App\Http\Requests\Sistema\AppraisalFormRequest;

    use App\Models\Sistema\Appraisal;
    use App\Models\Sistema\Company;
    use PDF;

    class AppraisalController extends StandardController
    {
        protected $model, $company;
        protected $title       = "Laudo";
        protected $view        = "Sistema.appraisal";
        protected $route       = "appraisal";
        protected $permissions = "appraisal";
        protected $name        = ["single" => "Laudo", "plus" => "Laudos"];


        public function __construct(Appraisal $appraisal, Company $company)
        {
    ...
    public function store(AppraisalFormRequest $request)
    {
        ...
        # FORMATAR DATA
        $dataForm['validity'] = formatDate($dataForm['validity'], 'Y-m-d');
         ...
         * @return \Illuminate\Http\Response
         */
        public function storeAdd(AppraisalFormRequest $request)
        {
            $dataForm = $request->all();
         ...
         * @return \Illuminate\Http\Response
         */
        public function update(AppraisalFormRequest $request, $id)
        {
         ...
         * @return \Illuminate\Http\Response
         */
        public function updateTrash(AppraisalFormRequest $request, $id)
        {
            //Pega todos os dados do categoria
            $dataForm = $request->all();
        ...
        public function search(Request $request)
        {
            ...
            // $data = $this->model
            // ->select("appraisal.*")
            // ->where("appraisal.deleted_at", '=', null)
            // ->leftJoin('employees', 'employees.id', '=', 'appraisal.employee_id')
