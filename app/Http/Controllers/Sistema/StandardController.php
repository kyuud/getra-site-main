    ...
    class StandardController extends Controller
    {
        ...
        if(!isset($dataForm["key-search"])){
            ...
            if ($totalItens == 0) {
                ...
                if ($itemsCurrentPage == 0) {
                    # REDIRECIONA PARA A ÚLTIMA PÁGINA COM REGISTROS
                    return redirect("/sistema/$this->route/pesquisar?key-search=$keySearch&page=$lastPage");
                }
            }
        ...
        public function searchTrash(Request $request)
        {
            ...
            if ($itemsCurrentPage == 0) {
                # REDIRECIONA PARA A ÚLTIMA PÁGINA COM REGISTROS
                return redirect("/sistema/$this->route/trash/pesquisar?key-search=$keySearch&page=$lastPage");
            }
        }
