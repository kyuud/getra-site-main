<?php
    ...
    use App\Http\Requests\Sistema\DoctorFormRequest;
    use App\Models\Sistema\Doctor;
    use Illuminate\Http\Request;
    class DoctorController extends StandardController
    {
    protected $model;
    protected $title        = "Médico";
    protected $view         = "Sistema.doctors";
    protected $route        = "doctors";
    protected $permissions  = "doctor";
    protected $name         = ["single" => "medico", "plus" => "medicos"];
     ...
     * @return \Illuminate\Http\Response
     */
    public function storeAdd(DoctorFormRequest $request)
    {
        $dataForm = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateTrash(DoctorFormRequest $request, $id)
    {
        //Pega todos os dados do categoria
        $dataForm = $request->all();
    ...
    public function trash()
        ...
        if(!isset($dataForm["key-search"])){
            ...
            $data = $this->model
                ...
                ->orWhere('crm', 'LIKE', "%{$keySearch}%")
                ->orWhere('specialty', 'LIKE', "%{$keySearch}%")
