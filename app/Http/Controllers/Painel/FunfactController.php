<?php
    ...
    use App\Http\Requests\Painel\FunfactFormRequest;
    ...
    {
    protected $model;
    protected $title        = "Funfact";
    protected $view         = "Painel.funfacts";
    protected $route        = "funfacts";
    protected $permissions  = "funfact";
    protected $name         = ["single" => "funfact", "plus" => "funfacts"];
    protected $upload       = [
        "name" => "image",
        "path" => "funfacts"
    ];
     ...
     */
    public function store(FunfactFormRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function storeAdd(FunfactFormRequest $request)
    {
        $dataForm = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(FunfactFormRequest $request, $id)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateTrash(FunfactFormRequest $request, $id)
    {
        //Pega todos os dados do categoria
        $dataForm = $request->all();
