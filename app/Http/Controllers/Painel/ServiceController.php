<?php
    ...
    use App\Http\Requests\Painel\ServiceFormRequest;
    ...
    protected $view         = "Painel.services";
    protected $route        = "services";
    protected $permissions  = "service";
    protected $name         = ["single" => "service", "plus" => "services"];
    protected $upload       = [
        "name" => "image",
        "path" => "services"
    ];
     ...
     * @return \Illuminate\Http\Response
     */
    public function storeAdd(ServiceFormRequest $request)
    {
        $dataForm = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateTrash(ServiceFormRequest $request, $id)
    {
        //Pega todos os dados do categoria
        $dataForm = $request->all();
