<?php
    ...
    use App\Http\Requests\Painel\BlogFormRequest;
    ...
    protected $view         = "Painel.blogs";
    protected $route        = "blogs";
    protected $permissions  = "blog";
    protected $name         = ["single" => "blog", "plus" => "blogs"];
    protected $upload       = [
        "name" => "image",
        "path" => "blogs"
    ];
     ...
     * @return \Illuminate\Http\Response
     */
    public function storeAdd(BlogFormRequest $request)
    {
        $dataForm = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateTrash(BlogFormRequest $request, $id)
    {
        //Pega todos os dados do categoria
        $dataForm = $request->all();
    ...
    public function search(Request $request)
        {
            ...
            $data = $this->model
                ...
                ->orWhere('highlights', 'LIKE', "%{$keySearch}%")
                ->orWhere('abstract', 'LIKE', "%{$keySearch}%")
                ->where("deleted_at", '=', null)
