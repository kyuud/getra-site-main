<?php
    ...
    use App\Http\Requests\Painel\PortfolioFormRequest;
    ...
    protected $view         = "Painel.portfolios";
    protected $route        = "portfolios";
    protected $permissions  = "portfolio";
    protected $name         = ["single" => "portfolio", "plus" => "portfolios"];
    protected $upload       = [
        "name" => "image",
        "path" => "portfolios"
    ];
     ...
     * @return \Illuminate\Http\Response
     */
    public function storeAdd(PortfolioFormRequest $request)
    {
        $dataForm = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateTrash(PortfolioFormRequest $request, $id)
    {
        //Pega todos os dados do categoria
        $dataForm = $request->all();
