    ...
    public function rules($id = null)
        {
            ...
            $rules = [
                ...
                'image'       => 'mimes:jpg,jpeg,png|file|max:2000|dimensions:width=265,height=280'
            ];

            # CREATE
            if ($this->getMethod() == "POST") {
                $rules['image'] = 'required:image|mimes:jpg,jpeg,png|file|max:2000|dimensions:width=265,height=280';
            }
        ...
        public function messages()
        {
            return [
                ...
                'image.dimensions'  => 'O campo imagem deve conter uma imagem de 265px x 280px!'
            ];
        }
    }
